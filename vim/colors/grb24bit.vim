...
exe 'hi CursorLineNr    guifg='.s:yellow        .' guibg='.s:none           .' cterm='.s:bold
...
exe 'hi Visual          guifg='.s:none          .' guibg='.s:gray           .' cterm='.s:none
...
exe 'hi ModeMsg         guifg='.s:gray          .' guibg='.s:cyan           .' cterm='.s:bold
...
exe 'hi Pmenu           guifg='.s:none          .' guibg='.s:black          .' cterm='.s:none
exe 'hi PmenuSel        guifg='.s:black         .' guibg='.s:green          .' cterm='.s:none
