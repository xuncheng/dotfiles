...
return {
  ...
  opts = {
    ...
    formatters = {
      prettier = { condition = function(_, ctx) return has_prettier_config(ctx) end },
    },
    -- vim.b.autoformat is the per-buffer switch; autocmds.lua uses it to keep
    -- rubocop off the Brewfile
